...
"^":"",
Iq:[function(){new E.b3(null,null).NP()},"$0","eE",0,0,2],
b3:{
"^":"a;DA,Vy",
Zk:[function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b
z=H.VM([],[K.T9])
for(y=0;y<26;){++y
x="Explosion_Sequence_A "+y+".png"
w=$.kQ().t(0,x)
if(w==null)H.vh(P.w("The frameId \""+x+"\" does not exist in the texture cache."))
z.push(w)}for(y=0;y<50;++y){x=C.Nm.gFV(z)
v=P.CP
u=new K.EX(null,0,0)
u.$builtinTypeInfo=[v]
t=new P.hL(u.x,u.y)
...
b=new K.Jd(null,1,!0,null,0,!1,u,x,0,0,C.Ba,C.un,!0,!1,null,null,null,v,t,s,r,q,p,o,n,m,l,k,j,i,!1,!1,!1,!1,!1,h,null,null,f,e,d,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,g,null,null,null,null,null,!1,!1)
if(x.gkZ().gqu())b.kv()
else x.BG(0,"update",b.gVZ())
b.mn=z
x=new P.hL(C.pr.j1(800),f.qX.y)
x.$builtinTypeInfo=[H.Kp(f,0)]
f.qX=x
x=C.pr.j1(600)
x=new P.hL(f.qX.x,x)
x.$builtinTypeInfo=[H.Kp(f,0)]
f.qX=x
x=new P.hL(0.5,u.qX.y)
x.$builtinTypeInfo=[H.Kp(u,0)]
u.qX=x
x=new P.hL(0.5,0.5)
x.$builtinTypeInfo=[H.Kp(u,0)]
u.qX=x
b.lP=C.pr.w7()*3.141592653589793
x=0.75+C.pr.w7()*0.5
v=new P.hL(e.qX.x,x)
v.$builtinTypeInfo=[H.Kp(e,0)]
e.qX=v
x=new P.hL(x,x)
x.$builtinTypeInfo=[H.Kp(e,0)]
e.qX=x
b.lS=C.pr.j1(27)
b.Vl=!0
x=this.DA
x.ww(b,x.VD.length)}C.ol.gm6(window).UT(this.gtV(this))},"$1","gCM",2,0,34],
WE:[function(a,b){this.Vy.wa(this.DA)
C.ol.gm6(window).UT(this.gtV(this))},"$1","gtV",2,0,11],
NP:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g
...
Fe:{
"^":"Ig;aa",
static:{"^":"kt,Si,vL,pi,tF,V7,n1,pQ,nf,YY,Hb,Io,VE,Tr,mv,eS,p4"}},
nc:{
"^":"Ig;aa",
static:{"^":"X8,po,Lg"}},
fE:{
