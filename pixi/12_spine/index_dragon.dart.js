...
return y}return a}}}],["","index_dragon.dart",,T,{
"^":"",
Iq:[function(){var z,y
z=new T.oj(null,null,null,"data/dragon/dragon.atlas")
z.rN()
...
this.aQ=K.Ld(this.XA)
this.C8(0)
z=this.aQ.ZQ
y=z.hf.fp.zs("flying")
if(y==null)H.vh(P.u("Animation not found: flying"))
x=z.ie(0)
...
z.dh(0,w)
z=this.DA
z.ww(this.aQ,z.VD.length)},"$1","gCM",2,0,33],
CD:[function(a,b){var z,y,x
if(this.aQ!=null){z=window.innerWidth
...
y=this.aQ.Zl
y.sy(0,x)
y.sx(0,x)}this.Vy.lO(0,window.innerWidth,window.innerHeight)},function(a){return this.CD(a,null)},"C8","$1","$0","ga7",0,2,34,5],
