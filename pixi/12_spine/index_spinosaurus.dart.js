...
return y}return a}}}],["","index_spinosaurus.dart",,N,{
"^":"",
Iq:[function(){var z,y
z=new N.u3(null,null,null,"data/spinosaurus/spinosaurus.atlas")
z.Xt()
...
z.dh(0,w)
z=this.DA
z.ww(this.K2,z.VD.length)},"$1","gCM",2,0,33],
...
z=window.innerHeight
if(typeof z!=="number")return z.V()
y.sy(0,z/1050)}this.Vy.lO(0,window.innerWidth,window.innerHeight)},function(a){return this.CD(a,null)},"C8","$1","$0","ga7",0,2,34,5],
WE:[function(a,b){C.ol.gm6(window).ml(this.gtV(this))
this.Vy.dd(this.DA)},"$1","gtV",2,0,11],
Xt:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h
