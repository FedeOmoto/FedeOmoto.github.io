...
Dc:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1
...
$.nh().u(0,"assets/bubble_32x32.png",y)}z=new K.T9(!1,y,null,null,!1,H.VM(new K.Vb(0,0,1,1),[P.KN]),null,null,0,0,!1,!1,null,null,null)
z.kQ()
z.Tx(y,null)
...
a1=new K.AE(s,z,0,0,C.Ba,C.un,!0,!1,null,null,null,t,r,q,p,o,n,m,l,k,j,i,h,g,!1,!1,!1,!1,!1,f,null,null,c,b,a,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,e,null,null,null,null,null,!1,!1)
if(z.gxW().gqu())a1.kv()
...
u.push(t)
t=this.DA
t.ww(a1,t.VD.length)}v=J.Vg(document.querySelector("#rnd"))
...
a.gMp().bM.sx(0,J.WB(a.x,z.LV))
a.Mp.bM.sy(0,J.WB(a.y,z.dB))
a.x=J.vX(a.x,z.yx)
a.y=J.vX(a.y,z.TQ)
if(J.xZ(a.x,z.ES))a.x=J.xH(a.x,z.ES)
else if(J.u6(a.x,-z.ES))a.x=J.WB(a.x,z.ES)
if(J.xZ(a.y,z.bK))a.y=J.xH(a.y,z.bK)
else if(J.u6(a.y,-z.bK))a.y=J.WB(a.y,z.bK)}}},1],["pixi","package:pixi_dart/pixi.dart",,K,{
"^":"",
...
Fe:{
"^":"Xa;aa",
static:{"^":"uk,Si,Vn,TI,RX,V7,n1,pQ,nf,Yr,Dl,dR,VE,fb,KW,eS,bw"}},
Op:{
"^":"Xa;aa",
static:{"^":"X8,Fh,wt"}},
fE:{
...
AE:{
"^":"IT;dU,z6,Yv,qB,bO,Ay,Zq,tY,L4,OA,bg,VD,Z7,xV,f0,VY,Gg,Uh,Vl,jB,hl,Oh,Lm,qe,qd,wP,hv,QR,dM,GY,ac,yd,bM,Zl,J6,lP,Fw,VR,wx,fY,rO,Og,ID,iG,qA,pX,ug,lU,Si,F6,vz,Yy,Ao,zy,dz,HC,zM,y4,q1",
...
if(typeof y!=="number")return H.s(y)
this.Zl.sy(0,z/y)}},function(){return this.Hw(null)},"kv","$1","$0","gVZ",0,2,28,5],
...
if(J.Hb(p,l+k))if(J.J5(o.qX.y,r.G6)){p=o.qX.y
o=r.G6
r=r.gfg(r)
if(typeof r!=="number")return H.s(r)
r=J.Hb(p,o+r)}else r=!1
else r=!1}else r=!1
if(r){b.N=a
...
if(J.fv(r).ga2()!==0||r.gqe().a2!==0){r.swP(z.WB(r,w))
if(r.wP){x=r.hl
if(x.a2!==0){x=x.lH
if(x.Gv>=4)H.vh(x.q7())
x.Iv(w)}r.dM=!0
...
else{u=new Float32Array(x.subarray(0,C.xt.C8(x,0,z*4*this.Ni,x.length)))
...
"^":"a;eo,FG,Gm,Av"},
O2:{
"^":"h1;Ce,QL,kY,PL,GZ,ru,Jp,Hc:wA@,C6,D7,eo,Hc",
$isO2:true},
AQ:{
"^":"jD;cK,t5,C6,D7,EL,kY,Jp,PL,GZ,ru,iG,Vi,RM,a2,aX,R,fg,Wr,eo,Ce,Oc",
...
z=this.aX
this.eo=J.jB(this.Wr,z,this.Vi,z,this.RM,!0)
y=$.w4()
x=this.cK
w=y.hP.nE(0,x)
y.FY.u(0,w,null)
...
y[1]=z
if(!!!window.WebGLRenderingContext)throw H.b(P.f("This browser does not support webGL. Try using the canvas renderer."))
z=J.jB(this.Wr,d,this.Vi,d,this.RM,!0)
this.eo=z
H.Go(z,"$isJo")
this.cK=$.w4().h(0,z)
...
T9:{
"^":"PZ;zz,xW<,M6<,WZ>,Sd<,c6<,Da<,hZ<,ac,yd,x5,TE,HF,Oa,O7",
gR:function(a){return this.ac},
gfg:function(a){return this.yd},
