...
"^":"",
Iq:[function(){E.nk()},"$0","eE",0,0,2],
JN:{
"^":"AE;CT>,ca<,LC,dU,z6,Yv,qB,bO,FV,Zq,tY,L4,OA,bg,VD,Z7,xV,f0,VY,Gg,Uh,Vl,jB,hl,Oh,Lm,qe,qd,wP,hv,QR,dM,GY,ac,yd,bM,Zl,J6,lP,Fw,VR,wx,fY,rO,Og,ID,iG,qA,pX,ug,lU,Si,F6,vz,Yy,Ao,zy,dz,HC,zM,y4,q1"},
qu:{
"^":"a;DA,Vy,RW,Ia,lF,mQ",
WE:[function(a,b){H.bQ(this.lF,new E.Ug(this))
this.Vy.dd(this.DA)
C.ol.gm6(window).ml(this.gtV(this))},"$1","gtV",2,0,23],
Wg:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c
z=K.lQ(!1,410,!1,null,630)
this.Vy=z
z=z.Wr
...
z.cp(C.Ba)
this.DA=z
z=K.Eo("BGrotate.jpg",null,C.P7)
this.RW=z
z=K.DM(z)
this.Ia=z
y=this.DA
y.ww(z,y.VD.length)
for(z=this.lF,h=0;h<20;++h){g=K.Eo("flowerTop.png",null,C.P7)
y=P.CP
x=new K.hL(null,0,0)
x.$builtinTypeInfo=[y]
w=new P.EX(x.x,x.y)
...
c=new E.JN(null,null,null,x,g,0,0,C.Ba,C.un,!0,!1,null,null,null,y,w,v,u,t,s,r,q,p,o,n,m,l,!1,!1,!1,!1,!1,k,null,null,i,f,e,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,j,null,null,null,null,null,!1,!1)
if(g.gBb().gqu())c.kv()
else g.BG(0,"update",c.gVZ())
...
f.qX=x
y=new P.EX(y,y)
y.$builtinTypeInfo=[H.Kp(f,0)]
f.qX=y
y=new P.EX(C.pr.j1(630),i.qX.y)
...
y.ww(c,y.VD.length)
c.FV=C.vH
c.CT=C.pr.w7()*3.141592653589793*2
c.ca=C.pr.w7()-0.8
c.LC=2+C.pr.j1(2)
z[h]=c}this.mQ=H.VM(new K.tn(-100,-100,830,610),[P.KN])
C.ol.gm6(window).ml(this.gtV(this))},
static:{nk:function(){var z=new E.qu(null,null,null,null,H.VM(Array(20),[K.AE]),null)
z.Wg()
return z}}},
Ug:{
"^":"Tp:12;a",
...
a.lP=-x-1.5707963267948966
z=this.a
if(J.u6(y.qX.x,z.mQ.HJ))y.sx(0,J.WB(y.qX.x,z.mQ.eJ))
else{x=y.qX.x
w=z.mQ
v=w.HJ
w=w.eJ
if(typeof w!=="number")return H.s(w)
if(J.xZ(x,v+w))y.sx(0,J.xH(y.qX.x,z.mQ.eJ))}if(J.u6(y.qX.y,z.mQ.G6))y.sy(0,J.WB(y.qX.y,z.mQ.ZD))
else{x=y.qX.y
w=z.mQ
v=w.G6
w=w.ZD
if(typeof w!=="number")return H.s(w)
if(J.xZ(x,v+w))y.sy(0,J.xH(y.qX.y,z.mQ.ZD))}}}},1],["pixi","package:pixi_dart/pixi.dart",,K,{
"^":"",
...
if(!this.wx||this.VR===0)return
z=H.Go(a.eo,"$isGc")
if(this.FV!==a.gHc()){a.sHc(this.FV)
y=a.gHc().aa
