...
Qr:function(a,b,c,d,e,f){return this.Bw(a,b,c,!0,d,e,f)},
...
Yi:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0
...
$.nh().u(0,"assets/pixel.png",y)}z=new K.T9(!1,y,null,null,!1,H.VM(new K.Vb(0,0,1,1),[P.KN]),null,null,0,0,!1,!1,null,null,null)
z.kQ()
z.Tx(y,null)
...
f=K.lu(1,1,P.CP)
e=K.lu(0,0,P.KN)
v=new K.Lz(null,!0,null,!1,v,u,t,s,r,q,p,o,n,m,l,k,j,i,!1,!1,!1,!1,!1,h,null,null,g,f,e,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,H.VM(new K.Vb(0,0,1,1),[P.FK]),null,null,null,null,null,!1,!1)
v.cp(null)
this.DA=v
v=this.xC
u=Array(v)
...
a0=new K.AE(u,z,0,0,C.Ba,C.un,!0,!1,null,null,null,t,s,r,q,p,o,n,m,l,k,j,i,h,!1,!1,!1,!1,!1,g,null,null,e,c,b,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,f,null,null,null,null,null,!1,!1)
if(z.gxW().gqu())a0.kv()
...
AE:{
"^":"IT;dU,z6,Yv,qB,bO,FV,Zq,tY,L4,OA,bg,VD,Z7,xV,f0,VY,Gg,Uh,Vl,jB,hl,Oh,Lm,qe,qd,wP,hv,QR,dM,GY,ac,yd,bM,Zl,J6,lP,Fw,VR,wx,fY,rO,Og,ID,iG,qA,pX,ug,lU,Si,F6,vz,Yy,Ao,zy,dz,HC,zM,y4,q1",
...
a.Pt=y
z.imageSmoothingEnabled=y===C.fJ}y=J.vj(this.z6)
x=this.z6
w=this.dU
if(y!=null){y=J.vj(x)
y=y.gBb(y)
...
v=this.d
u=J.RE(v)
t=J.xH(H.VM(new P.EX(a.clientX,a.clientY),[null]).x,u.gBb(v))
s=z.iA.R
r=u.gR(v)
if(typeof r!=="number")return H.s(r)
w.sx(0,J.vX(t,s/r))
...
x=this.c
v=J.RE(x)
u=J.xH(H.VM(new P.EX(a.clientX,a.clientY),[null]).x,v.gBb(x))
t=z.iA.R
s=v.gR(x)
...
u=this.d
t=J.RE(u)
s=J.xH(H.VM(new P.EX(a.clientX,a.clientY),[null]).x,t.gBb(u))
r=y.iA.R
q=t.gR(u)
if(typeof q!=="number")return H.s(q)
v.sx(0,J.vX(s,r/q))
...
else{u=new Float32Array(x.subarray(0,C.fm.C8(x,0,z*4*this.Ni,x.length)))
...
$isO2:true},
AQ:{
"^":"jD;cK,t5,C6,D7,EL,kY,LV,PL,GZ,ru,iG,Vi,RM,i0,aX,R,fg,Wr,eo,Ce,Oc",
...
z=this.aX
this.eo=J.oc(this.Wr,z,this.Vi,z,this.RM,!0)
y=$.w4()
x=this.cK
w=y.hP.Rz(0,x)
y.FY.u(0,w,null)
...
y[1]=z
if(!!!window.WebGLRenderingContext)throw H.b(P.f("This browser does not support webGL. Try using the canvas renderer."))
z=J.oc(this.Wr,d,this.Vi,d,this.RM,!0)
this.eo=z
H.Go(z,"$isJo")
this.cK=$.w4().h(0,z)
...
J.oc=function(a,b,c,d,e,f){return J.RE(a).Qr(a,b,c,d,e,f)}
