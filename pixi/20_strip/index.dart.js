...
"%":"CanvasGradient|CanvasPattern|MediaError|MediaKeyError|Navigator|PositionError|SQLError|SVGAnimatedEnumeration|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGAnimatedTransformList|SVGPointList|WebGLBuffer|WebGLFramebuffer|WebGLProgram|WebGLRenderbuffer|WebGLShader|WebGLUniformLocation"},
kn:{
"^":"Gv;",
...
$isuH:true,
static:{"^":"uW,Q2,GG,GZ,Gb,Np,ca,qJ,p7,d1,zf,BB,Kq,oS,jG,dV,I8,Zh,b4,V2,pX,B3,z7,Yz,dA,Ok,Rp,Kd,O0,Lh,yF,cG,FI,vd,wZ,V4,GU,oL,CB,VW,UY,mG,Ke,qs,Mk,nE,Sf,cE,rc,Uq,uB,Qt,DI,KO,jF,Sd,zF,wA,Te,lZ,z4,iW,fC,Jp,t9,wQ,Mp,on,Ut,lg,m6,Fj,hf,XM,tu,yT,o8,kk,Lr,IX,LY,cj,Jn,tV,Mu,ZT,yr,VT,U0,pC,I7,Ck,lk,G0,Qh,nu,CM,ND,zN,wo,Lm,mt,ZX,Bx,aU,fw,pI,M7,uA,fO,oP,i7,iR,CO,Lb,aK,Ym,vN,ne,eV,Xh,zk,N8,e2,CH,wR,EV,AY,Zy,MG,dY,Jm,NQ,wj,CJ,cI,y7,Lj,zR,eI,nb,jr,zm,yw,Yv,SB,Us,kI,mg,Xo,ye,k2",Xx:function(a,b){var z=J.x(b)
...
"^":"",
Iq:[function(){E.Ty()},"$0","eE",0,0,2],
V3:{
"^":"a;DA,Vy,cB,Av",
WE:[function(a,b){var z,y,x
this.Av+=0.1
for(z=0;y=this.cB,z<y.length;++z){y=y[z]
x=this.Av
J.Id(y,Math.sin(z*0.5+x)*30)
y=this.cB
if(z>=y.length)return H.e(y,z)
y=y[z]
x=this.Av
J.BI(y,z*45.9+Math.cos(z*0.3+x)*20)}this.Vy.dd(this.DA)
C.ol.gm6(window).ml(this.gtV(this))},"$1","gtV",2,0,22],
zh:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a
z=new S.uH(S.Bz(172,228,85,null))
y=H.VM(Array(3),[P.CP])
x=H.VM([],[K.fE])
w=K.Ey("mouseover")
v=K.Ey("mouseout")
...
this.Vy=y
y=y.Wr
y.className="rendererView"
document.body.appendChild(y)
for(g=0;g<20;++g){z=this.cB
y=P.FK
x=new K.hL(null,g*45.9,0)
x.$builtinTypeInfo=[y]
w=new P.EX(x.x,x.y)
w.$builtinTypeInfo=[y]
x.qX=w
z.push(x)}f=$.kQ().t(0,"snake.png")
if(f==null){e=$.nh().t(0,"snake.png")
d=!C.xB.nC("snake.png","data:")
if(e==null){c=document.createElement("img",null)
J.Yj(c,"snake.png")
if(d)J.aP(c,"")
e=K.ac(c,C.P7)
e.um="snake.png"
$.nh().u(0,"snake.png",e)}f=new K.T9(!1,e,null,null,!1,H.VM(new K.tn(0,0,1,1),[P.KN]),null,null,0,0,!1,!1,null,null,null)
f.kQ()
f.Tx(e,null)
$.kQ().u(0,"snake.png",f)}z=this.cB
y=H.VM([],[K.fE])
x=K.Ey("mouseover")
w=K.Ey("mouseout")
v=K.Ey("mousemove")
...
j=K.lu(1,1,P.CP)
i=K.lu(0,0,P.KN)
b=new K.Nq(z,f,null,null,null,null,!0,null,null,null,null,y,x,w,v,u,t,s,r,q,p,o,n,m,!1,!1,!1,!1,!1,l,null,null,k,j,i,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,H.VM(new K.tn(0,0,1,1),[P.FK]),null,null,null,null,null,!1,!1)
b.pZ()
b.zr()
k.sx(0,-459)
z=H.VM([],[K.fE])
...
k=K.lu(1,1,P.CP)
j=K.lu(0,0,P.KN)
a=new K.IT(z,y,x,w,v,u,t,s,r,q,p,o,n,!1,!1,!1,!1,!1,m,null,null,l,k,j,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,H.VM(new K.tn(0,0,1,1),[P.FK]),null,null,null,null,null,!1,!1)
y=window.innerWidth
...
static:{Ty:function(){var z=new E.V3(null,null,H.VM([],[[K.hL,P.FK]]),0)
z.zh()
...
$1:function(a){return a.md()}},
Nq:{
"^":"xK;cB,z6,SZ,kH,MY,cT,AJ,h7,eE,i7,nY,VD,Z7,xV,f0,VY,Gg,Uh,Vl,jB,hl,Oh,Lm,qe,qd,Oo,hv,QR,dM,GY,ac,yd,bM,Zl,J6,lP,Fw,VR,wx,fY,rO,Og,ID,iG,qA,pX,ug,lU,Si,F6,vz,Yy,Ao,zy,dz,HC,zM,y4,q1",
pZ:function(){var z=this.cB.length
this.kH=new Float32Array(z*4)
z=this.cB.length
this.SZ=new Float32Array(z*4)
z=this.cB.length
this.MY=new Float32Array(z*2)
z=this.cB.length
this.cT=new Uint16Array(z*2)},
...
u[1]=1
for(s=z-1,r=1;r<z;++r){q=r*4
p=r/s
o=q+1
n=q+2
m=q+3
if((r&1)===1){if(q>=x)return H.e(y,q)
y[q]=p
if(o>=x)return H.e(y,o)
y[o]=0
if(n>=x)return H.e(y,n)
y[n]=p
if(m>=x)return H.e(y,m)
y[m]=1}else{if(q>=x)return H.e(y,q)
y[q]=p
if(o>=x)return H.e(y,o)
y[o]=0
if(n>=x)return H.e(y,n)
...
if(m>=x)return H.e(y,m)
y[m]=1}q=r*2
if(q>=v)return H.e(w,q)
w[q]=1
o=q+1
if(o>=v)return H.e(w,o)
w[o]=1
if(q>=t)return H.e(u,q)
u[q]=q
if(o>=t)return H.e(u,o)
u[o]=o}},
md:function(){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=this.cB
if(z.length===0)return
y=C.Nm.gFV(z)
x=K.lu(0,0,P.CP)
w=this.cB.length
for(z=w-1,v=0;v<w;++v,y=s){u=this.cB
t=u.length
if(v>=t)return H.e(u,v)
s=u[v]
r=v*4
q=v<t-1?u[v+1]:s
u=J.RE(q)
t=J.RE(y)
p=J.Oq(J.xH(u.gx(q),t.gx(y)))
p=new P.EX(x.qX.x,-p)
p.$builtinTypeInfo=[H.Kp(x,0)]
x.qX=p
u=J.Oq(J.xH(u.gy(q),t.gy(y)))
t=new P.EX(u,x.qX.y)
t.$builtinTypeInfo=[H.Kp(x,0)]
x.qX=t
if((1-v/z)*10>1);t=x.qX.y
t=J.vX(t,t)
if(typeof t!=="number")return H.s(t)
o=Math.sqrt(u*u+t)
u=this.z6.gyd()
...
u=this.kH
t=J.RE(s)
p=J.WB(t.gx(s),x.qX.x)
if(r>=u.length)return H.e(u,r)
u[r]=p
p=this.kH
u=r+1
m=J.WB(t.gy(s),x.qX.y)
if(u>=p.length)return H.e(p,u)
p[u]=m
m=this.kH
u=r+2
p=J.xH(t.gx(s),x.qX.x)
if(u>=m.length)return H.e(m,u)
m[u]=p
p=this.kH
u=r+3
t=J.xH(t.gy(s),x.qX.y)
if(u>=p.length)return H.e(p,u)
p[u]=t}K.IT.prototype.md.call(this)}},
xK:{
"^":"IT;",
Qt:function(a){var z,y,x,w,v,u,t,s,r
if(!this.wx||this.VR<=0)return
a.LV.fZ(0)
if(this.h7==null){z=H.Go(a.eo,"$isJo")
this.h7=z.createBuffer()
this.eE=z.createBuffer()
this.i7=z.createBuffer()
this.nY=z.createBuffer()
z.bindBuffer(34962,this.h7)
z.bufferData(34962,this.kH,35048)
z.bindBuffer(34962,this.i7)
z.bufferData(34962,this.SZ,35044)
z.bindBuffer(34962,this.nY)
z.bufferData(34962,this.MY,35044)
z.bindBuffer(34963,this.eE)
z.bufferData(34963,this.cT,35044)}y=a.wP
y.N7(y.uc)
z=H.Go(a.eo,"$isJo")
x=a.C6
w=a.D7
...
y=v.Ww
u=this.lU
z.uniformMatrix3fv(y,!1,new Float32Array(H.XF([u.a,u.c,0,u.b,u.d,0,u.JO,u.G8,1])))
u=v.An
y=x.qX
t=y.x
y=y.y
...
z.uniform2f(y,-u,-t)
z.uniform1f(v.VR,1)
if(!this.AJ){z.bindBuffer(34962,this.h7)
z.bufferSubData(34962,0,this.kH)
z.vertexAttribPointer(v.t6,2,5126,!1,0,0)
z.bindBuffer(34962,this.i7)
z.vertexAttribPointer(v.H6,2,5126,!1,0,0)
z.activeTexture(33984)
s=$.w4().FY.t(0,z)
r=this.z6.gxW().gxS().t(0,s)
z.bindTexture(3553,r==null?K.UI(this.z6.gxW(),z):r)
z.bindBuffer(34963,this.eE)}else{this.AJ=!1
z.bindBuffer(34962,this.h7)
...
z.bindTexture(3553,r==null?K.UI(this.z6.gxW(),z):r)
z.bindBuffer(34963,this.eE)
z.bufferData(34963,this.cT,35044)}z.drawElements(5,this.cT.length,5123,0)
a.LV.AJ=!0},
hn:function(a6){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g,f,e,d,c,b,a,a0,a1,a2,a3,a4,a5
z=H.Go(a6.eo,"$isGc")
y=a6.gSv()
x=this.lU
if(y){y=x.a
...
t=this.lU.G8
z.setTransform(y,w,v,u,x,t<0?Math.ceil(t):Math.floor(t))}else z.setTransform(x.a,x.c,x.b,x.d,x.JO,x.G8)
for(y=this.kH.length/2-2,s=0;s<y;++s){r=s*2
x=this.kH
w=x.length
...
a4=d*l
a5=n*c
z.transform((m+a*o+p*a1-a0*o-t-q*a1)/a2,(x+a*j+l*a1-a0*j-a3-n*a1)/a2,(u+q*b+c*o-p*b-v-d*o)/a2,(a4+n*b+c*j-l*b-a5-d*j)/a2,(w*o+t*b+v*a1-m*b-k*o-u*a1)/a2,(w*j+a3*b+a5*a1-x*b-k*j-a4*a1)/a2)
z.drawImage(J.uq(this.z6.gxW()),0,0)
z.restore()}}},
ux:{
"^":"a;"},
hL:{
...
if(typeof v!=="number")return H.s(v)
z.sy(0,J.vX(x,t/v))
H.bQ(this.EJ,new K.P6(this))},"$1","gKX",2,0,23],
...
z=z.kj
z.sx(0,-10000)
z.sy(0,-10000)},"$1","gRy",2,0,23],
ux:[function(a){var z={}
if(this.AJ)this.o5()
this.av.GW=a
z.a=!1
H.bQ(this.EJ,new K.iB(z,this))},"$1","gQM",2,0,23],
WB:function(a,b){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=b.gkj()
if(!a.gd3())return!1
y=a.lU
x=y.a
...
n=a.fY
if(n!=null){m=P.FK
o=new K.hL(null,t*q*o+-w*q*p+(s*w-v*t)*q,x*q*p+r*q*o+(-s*x+v*u)*q)
o.$builtinTypeInfo=[m]
r=o.x
p=new P.EX(r,o.y)
p.$builtinTypeInfo=[m]
o.qX=p
if(J.J5(r,n.Bb)){r=o.qX.x
p=n.Bb
m=n.gR(n)
if(typeof m!=="number")return H.s(m)
if(J.Bl(r,p+m))if(J.J5(o.qX.y,n.G6)){r=o.qX.y
p=n.G6
n=n.gfg(n)
if(typeof n!=="number")return H.s(n)
n=J.Bl(r,p+n)
...
if(r){b.N=a
return!0}return!1}H.bQ(a.gwd(a),new K.ez(this,a,b))
return!1},
...
x=J.fi(a)
z.a=null
J.kH(x,new K.eN(z,this,a,y))},"$1","gTD",2,0,24],
Su:[function(a){var z
if(this.AJ)this.o5()
z=this.e8.getBoundingClientRect()
J.fD(a)
J.kH(J.fi(a),new K.bC(this,a,z))},"$1","gEU",2,0,24],
eR:[function(a){var z
if(this.AJ)this.o5()
z=this.e8.getBoundingClientRect()
J.kH(J.fi(a),new K.PA(this,a,z))},"$1","gEV",2,0,24],
static:{"^":"r3,ya"}},
NB:{
"^":"Tp:11;",
...
jD:{
"^":"a;R>,fg>",
Wt:function(a,b,c,d){var z=document.createElement("canvas",null)
this.Wr=z
J.vP(this.Wr,this.R)
...
w=x==null?null:H.VK(x,z.J4())
y.gxS().t(0,w)
t.bindTexture(3553,y.gxS().t(0,w))
y.gD4()
t.pixelStorei(37441,0)
C.mx.ZE(t,3553,0,6408,6408,5121,y.gFF(y))
y.gPt()
...
y.gAJ().u(0,w,!1)}this.eo.drawElements(4,b*6,5123,c*6*2);++this.Oc.QL},
...
z=$.w4().FY.t(0,b)
if(a.gqu()){a.xS.u(0,z,b.createTexture())
...
b.texParameteri(3553,10241,y?9729:9728)
...
this.H2(0,W.K1("update",!0,!0,this))},"$1","gM3",2,0,26],
