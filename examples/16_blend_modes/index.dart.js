...
y=this.DA
y.ww(z,y.VD.length)
for(z=this.CT,y=this.ca,x=this.LC,w=this.lF,u=0;u<20;++u){t=K.Eo("flowerTop.png",null,C.P7)
v=P.CP
s=new K.hL(null,0,0)
s.$builtinTypeInfo=[v]
r=new P.EX(s.x,s.y)
...
m=new K.AE(s,t,0,0,C.Nd,C.un,!0,!1,null,!1,null,null,v,q,p,o,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,r,null,null,null,null,null,!1,!1)
if(t.gBb().gqu())m.kv()
else t.BG(0,"update",m.gVZ())
v=new P.EX(s.qX.x,0.5)
v.$builtinTypeInfo=[H.Kp(s,0)]
s.qX=v
v=new P.EX(0.5,0.5)
v.$builtinTypeInfo=[H.Kp(s,0)]
s.qX=v
v=0.8+C.pr.w7()*0.3
s=new P.EX(p.qX.x,v)
s.$builtinTypeInfo=[H.Kp(p,0)]
p.qX=s
v=new P.EX(v,v)
v.$builtinTypeInfo=[H.Kp(p,0)]
p.qX=v
v=new P.EX(C.pr.j1(630),q.qX.y)
v.$builtinTypeInfo=[H.Kp(q,0)]
q.qX=v
v=C.pr.j1(410)
v=new P.EX(q.qX.x,v)
v.$builtinTypeInfo=[H.Kp(q,0)]
...
v.ww(m,v.VD.length)
m.FV=C.vH
z.u(0,m,C.pr.w7()*3.141592653589793*2)
y.u(0,m,C.pr.w7()-0.8)
x.u(0,m,2+C.pr.j1(2))
w[u]=m}this.mQ=H.VM(new K.tn(-100,-100,830,610),[P.KN])
C.ol.gm6(window).ml(this.gtV(this))},
static:{nk:function(){var z=new E.qu(null,null,null,null,H.VM(Array(20),[K.AE]),new P.kM(null),new P.kM(null),new P.kM(null),null)
z.Wg()
return z}}},
Ug:{
"^":"Tp:12;a",
...
z=this.a
y=z.CT
y.u(0,a,J.WB(y.t(0,a),J.vX(z.ca.t(0,a),0.01)))
x=J.RE(a)
w=x.gbM(a)
v=J.RE(w)
u=v.gx(w)
...
s=C.CD.yu(C.ON.UD(w*s))
if(typeof u!=="number")return u.g()
r.sy(x,u+s)
y=y.t(0,a)
if(typeof y!=="number")return y.J()
a.slP(-y-1.5707963267948966)
y=a.bM
x=y.qX.x
w=z.mQ
v=w.HJ
if(typeof x!=="number")return x.C()
if(x<v)y.sx(0,x+w.eJ)
else{w=w.eJ
if(x>v+w)y.sx(0,x-w)}x=y.qX.y
z=z.mQ
w=z.G6
if(typeof x!=="number")return x.C()
if(x<w)y.sy(0,x+z.ZD)
else{z=z.ZD
if(x>w+z)y.sy(0,x-z)}}}},1],["pixi","package:pixi_dart/pixi.dart",,K,{
"^":"",
...
init.metadata=[{func:"zx",args:[P.qU]},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"I6",ret:P.qU},{func:"NT"},{func:"aB",args:[null]},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"yV",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:P.qU,args:[P.KN]},{func:"Za",args:[P.qU,null]},{func:"ZH",args:[P.KN]},{func:"iR",args:[P.KN,null]},{func:"CE",void:true,args:[P.FK]},{func:"H8",void:true,opt:[W.He]},{func:"xL",void:true,args:[P.Sl]},{func:"he",void:true,args:[W.He]},];$=null
