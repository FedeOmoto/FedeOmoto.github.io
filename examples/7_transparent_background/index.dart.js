...
t=$.kQ().t(0,"bunny.png")
if(t==null){s=$.nh().t(0,"bunny.png")
r=!C.xB.nC("bunny.png","data:")
if(s==null){q=W.jm(null,"bunny.png",null)
if(r)J.aP(q,"")
s=K.ac(q,null)
s.um="bunny.png"
$.nh().u(0,"bunny.png",s)}t=new K.T9(!1,s,null,null,null,null,null,null,!1,!1,!1,null,null,null)
t.kQ()
t.Tx(s,null)
$.kQ().u(0,"bunny.png",t)}z=K.lu(0,0,P.CP)
y=H.VM([],[K.fE])
x=K.lu(0,0,P.KN)
w=K.lu(1,1,P.CP)
v=K.lu(0,0,P.KN)
y=new K.AE(z,t,0,0,C.Nd,C.un,!0,!1,null,!1,null,null,y,x,w,v,0,null,1,!0,null,!1,!1,null,null,1,!1,"pointer",new K.yW(1,0,0,1,0,0),0,1,null,H.VM(new K.tn(0,0,1,1),[P.FK]),null,null,null,null,null,!1,!1)
y.Vw(t)
this.mo=y
z.sx(0,0.5)
this.mo.dU.sy(0,0.5)
...
if(w<=w){v=y.ID
if(v!=null){u=v.VD
p=H.Ri(u,y,0,u.length)
o=v.Rw(p)
if(v.fN!=null)o.GO()
o.sID(null)
if(p<0||p>=u.length)H.vh(P.N(p))
u.splice(p,1)[0]}y.ID=z
